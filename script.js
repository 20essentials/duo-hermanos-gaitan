/* =======================SET======================= */
const nameBand = "DÚO HNOS. GAITÁN CASTRO";
...
let nameSongs = [
	...
	"MI AMOR HA MUERTO", /*4*/
	"PROFESORITA", /*5*/
	"PASAJERO EN EL CAMINO", /*6*/
	"OLVIDO QUE NUNCA LLEGAS", /*7*/
	"PARA CHASKA", /*8*/
	"MI DULCE AMOR", /*9*/
	"POPURRÍ DE CARNAVALES", /*10*/
	"RÉQUIEM PARA UN AMOR ", /*11*/
	"ESCRITO ESTÁ", /*12*/
	"LINDA ANDAHUAYLINA", /*13*/
	"RÍO MANTARO", /*14*/
	"DUELE SENTIR QUE AÚN TE AMO", /*15*/
	"NUESTRA PROMESA", /*16*/
	"QUIERO", /*17*/
	"AY... MI CHOLITA", /*18*/
	"HOLA, CÓMO ESTÁS?", /*19*/
	"TU VIDA ME PERTENECE", /*20*/
]
